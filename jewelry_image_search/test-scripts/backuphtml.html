...
GOOGLE_GENAI_API_KEY = os.getenv("GOOGLE_GENAI_API_KEY", "AIzaSyDVwkLbC2az9dzwAIqYeIh-WDq1pWAqwhw")
...
def process_with_gemini(image_path: str) -> bytes:
    ...
    prompt = ("Please analyze the attached image. First, identify the primary object of attention "
              ...
              "object placed on a clean, plain white background. Make sure the image quality "
              "remains high and the object is clearly visible.")
